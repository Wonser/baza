    ...
    <div class="account-wrap">
        ...
        <div class="account-list">
            <div class="account-list-head">
                <p class="h5">персонажи</p>
            </div>
            <div class="account-table account-table_free">
                <div class="account-table-item account-table-item_head">
                    <div class="account-table-item-inner">
                        <span class="body-14mu">имя</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">аккаунт</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">уровень</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">клан</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">PVP</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">PK</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">Игровое время</span>
                    </div>
                    <div class="account-table-item-inner">
                        <span class="body-14mu">последний вход</span>
                    </div>
                </div>
                <div class="account-table-item">
                    <div class="account-table-item-inner">
                        <p class="body-16rp">Artsman</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">MGlogin</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">86</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">Enemy</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">234</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">18</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">1137 ч 35 м</p>
                    </div>
                    <div class="account-table-item-inner">
                        <p class="body-16rp">23/12/24, 20:54:33</p>
                    </div>
                </div>
                <div class="account-table-item">
                    <div class="account-table-item-inner">
                ...
                </div><div class="account-table-item">
                    <div class="account-table-item-inner">
                        <p class="body-16rp">Artsman</p>
                    </div>
                    <div class="account-table-item-inner">
