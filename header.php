    ...
    <div class="preloader">
        <div class="preloader-wrap">
            ...
            <div class="preloader-wrap-inner">
    ...
    <header class="header">
        <div class="header-left">
            <div class="menu-btn">
                <img src="assets/img/menu.svg" class="svg">
            </div>
            <a href="#" class="logo">
                <img src="assets/img/logo.svg" alt="logo">
            </a>
        ...
        <nav class="header-nav">
            <ul class="header-menu">
                <li class="header-menu-item body-14mu"><a href="#">О сервере</a></li>
                <li class="header-menu-item body-14mu"><a href="#">Новости</a></li>
    ...
    <div style="display: none;">
        <div class="box-modal menu-modal" id="menuModal">
            <div class="menu-modal-head">
                <div class="arcticmodal-close box-modal-close">
                    <img src="assets/img/close.svg" alt="svg">
                </div>
                <a href="#" class="logo">
                    <img src="assets/img/logo.svg" alt="logo">
                </a>
            ...
            <ul class="modal-menu">
                <li class="modal-menu-item">
                    <span class="body-12mu">01</span> <a href="#" class="h4">О сервере</a>
                </li>
                <li class="modal-menu-item">
                    <span class="body-12mu">02</span><a href="#" class="h4">Новости</a>
                </li>
                <li class="modal-menu-item">
                    <span class="body-12mu">03</span><a href="#" class="h4">Скачать файлы</a>
                </li>
                <li class="modal-menu-item">
                    <span class="body-12mu">04</span><a href="#" class="h4">Пожертвования</a>
                </li>
                <li class="modal-menu-item">
                    <span class="body-12mu">05</span><a href="#" class="h4">Discord</a>
                </li>
            </ul>
            <div class="socials">
