...
<?php include 'header.php'; ?>
    ...
    <main>
        <section class="s404">
            <picture class="s404-bg">
                <source srcset="assets/img/404.webp">
                <img src="assets/img/404.png" alt="baza">
            </picture>
            <div class="s404-wrap">
                <picture class="s404-img">
                ...
                <a href="#" class="primary-btn body-14mu">На главную</a>
            </div>
        </section>
    </main>
