    ...
    <div class="account-wrap">
        ...
        <div class="account-help">
            <div class="account-help-icon">
                <img src="assets/img/life-ring.svg">
            </div>
            <p class="h6">Нужна помощь?</p>
            <span class="body-16rp">
                Задайте вопрос или сообщите о проблеме — наша команда поддержки свяжется с вами в кратчайшие сроки.
            </span>
            <a href="#" class="main-btn body-14mu">поддержка</a>
        </div>
...
<div style="display: none;">
    <div class="box-modal form-modal" id="changeModal">
        <form action="#" class="form-wrap">
            <div class="arcticmodal-close form-wrap-close">
                <img src="assets/img/close.svg" alt="svg" class="svg">
            </div>
