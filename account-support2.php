        ...
        <div class="account-chat">
            <div class="account-chat-left">
                ...
                <div class="account-chat-left-wrap">
                    ...
                    <div class="account-chat-list">
                        <div class="account-chat-list-item">
                            <div class="account-chat-list-item-head">
                                <p class="body-14m">Ticket</p>
                                <p class="body-14r">14 часов назад</p>
                            </div>
                            <span class="body-14r">Длинный текст сообщения тикета который ...</span>
                        </div>
                        <div class="account-chat-list-item">
                            <div class="account-chat-list-item-head">
                                <p class="body-14m">Ticketverytlongname1234</p>
                                <p class="body-14r">14 часов назад</p>
                            </div>
                            <span class="body-14r">Короткий текст сообщения тикета.</span>
                        </div>
                        <div class="account-chat-list-item">
                            <div class="account-chat-list-item-head">
                                <p class="body-14m">Ticketverytlongname1234</p>
            ...
            <div class="account-chat-right">
                <div class="account-chat-right-tab">
                    <div class="chat-item">
                        <div class="chat-item-head">
                            <div class="back-chat">
                                <img src="assets/img/back.svg">
                            </div>
                            <div class="chat-item-head-left body-14m">
                                <p>Ticketverytlongname1234</p>
                                <span>test</span>
                            </div>
                            <div class="chat-item-head-right">
                                <div class="tag body-12m">Низкий</div>
                                <div class="settings">
                        ...
                        <div class="chat-item-content">
                            <div class="message">
                                <div class="message-img">
                                    ...
                                    <span class="body-12m">Агент</span>
                                </div>
                                <div class="message-text">
                                    <div class="message-text-wrap body-14m">
                                        Привет
                                    </div>
                                    <span class="body-14r">14 часов назад</span>
                                </div>
                            </div>
                            <div class="message">
                                <div class="message-img">
                                ...
                                <div class="message-text">
                                    <div class="message-text-wrap body-14m">
                                        Длинный текст сообщения тикета который. Длинный текст сообщения тикета который ...
                                    </div>
                                    <span class="body-14r">14 часов назад</span>
                                </div>
                            </div>
                        ...
                        <div class="chat-item-send">
                            <input type="text" class="form-input body-16rp" placeholder="Написать сообщение">
                            <input type="submit" class="main-btn body-14mu" value="Отправить">
                        </div>
                    </div>
                </div>
                <div class="account-chat-right-tab">
